...
export const NavbarComponent = () => {
  ...
  return (
    <Navbar className="mx-auto max-w-full shadow-none border-none rounded-none bg-transparent backdrop-saturate-100 backdrop-blur-none -mb-[100px] z-50 sticky top-0">
